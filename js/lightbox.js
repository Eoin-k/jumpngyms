...
//	Configuration
//
var fileLoadingImage = "imgs/loading.gif";		
var fileBottomNavCloseImage = "imgs/closelabel.gif";
...
//		$('outerImageContainer').offsetLeft	=	parseInt($('outerImageContainer').offsetLeft) - 100;
		//alert(this.xScale)
